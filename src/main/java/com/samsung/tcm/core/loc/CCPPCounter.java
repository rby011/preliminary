 ...
 *
 */
public class CCPPCounter extends CodeCounter
{
   ...
   private int truncateLinesCount;
    ...
    */
   public CCPPCounter(LanguageProperties langProps)
   {
   ...
   protected void CountFileLSLOC(UCCFile cntrResult)
   {
      ...
      try
      {
         ...
         while (line != null)
         {
            ...
            // Replace all << or >> on any lines containing stream keywords
            line = DeleteStreamCharacters(streamList, line);
   ...
   /**
    * Function for deleting any {@literal <}{@literal <}/{@literal >}{@literal >} characters if the line contains a stream keyword

    * @param streamList List of stream Strings
    * @param line Line coming in from file 
    * @return Line with any {@literal <}{@literal <}/{@literal >}{@literal >} characters removed if the line contained a stream keyword
    */
