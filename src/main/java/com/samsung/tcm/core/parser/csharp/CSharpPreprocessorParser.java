        ...
        try {
            ...
            switch (_input.LA(1)) {
                    ...
                    enterOuterAlt(_localctx, 3);
                {
                    ...
                    setState(18);
                    directive_new_line_or_sharp();
                    ((PreprocessorConditionalContext) _localctx).value = ((PreprocessorConditionalContext) _localctx).expr.value.equals("true") && allConditions();
                    conditions.push(((PreprocessorConditionalContext) _localctx).expr.value.equals("true"));
                }
                break;
                case ELIF:
                    _localctx = new PreprocessorConditionalContext(_localctx);
                    ...
                    enterOuterAlt(_localctx, 5);
                {
                    ...
                    if (!conditions.peek()) {
                        conditions.pop();
                        ((PreprocessorConditionalContext) _localctx).value = true && allConditions();
                        conditions.push(true);
                    } else ((PreprocessorConditionalContext) _localctx).value = false;
                }
                break;
                    ...
                    enterOuterAlt(_localctx, 6);
                {
                    ...
                    directive_new_line_or_sharp();
                    conditions.pop();
                    ((PreprocessorConditionalContext) _localctx).value = conditions.peek();
                }
                break;
                case LINE:
