 ...
 * -----------------------------------------------------------------------
 * Xamarin.Forms.Core.UnitTests.Date_UILK_Test             TC        POSITVE
 ...
 * </pre>
 */
class CSharpTestcaseAnalyzer_Test02 {
    @Test
    void testWithOneFile() {
        try {
            // DO ANALYSIS
            InputStream file = this.getClass().getClassLoader().getResourceAsStream("csharp_analysis/testcase02.cs");
