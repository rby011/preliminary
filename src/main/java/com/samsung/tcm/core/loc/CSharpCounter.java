...
/**
 * CSharpCounter class performs various code counting operations on baseline(s)
 * identified by the user.  It contains algorithms/methods to count CSharp
 * programming language files.
 *
 * @author Integrity Applications Incorporated
 */
public class CSharpCounter extends CodeCounter {
    /**
     * Instantiate the Log4j2 logger for this class
     */
    private static final Logger logger = LogManager.getLogger(CSharpCounter.class);
    ...
    /**
     * Default constructor to instantiate a CSharpCounter object
     *
     * @param langProps ELanguage properties for this counter
     */
    public CSharpCounter(LanguageProperties langProps) {
        ...
        try {
            ...
            while (line != null) {
                ...
                if (!line.isEmpty()) {
                    ...
                    // Put attributes on their own line
