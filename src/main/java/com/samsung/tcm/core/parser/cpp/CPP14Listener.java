...
public interface CPP14Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CPP14Parser#defineDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterDefineDeclaration(CPP14Parser.DefineDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link CPP14Parser#defineDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitDefineDeclaration(CPP14Parser.DefineDeclarationContext ctx);
	/**
